...
class V1::ConfirmationTokensController < ApplicationController
  ...
  def index
    ...
    if params['confirm_token']
      ...
      render(json: { data: [{ id: 999, type: 'confirmation_tokens', attributes: {} }] }.to_json, status: :ok)
    end
  end
  ...
  def show
    ...
    if current_user.save
      ...
      render(json: { data: { id: 1, type: 'confirmation_tokens', attributes: {} } }.to_json, status: :ok)
    else
      head(500)
    end
  end
