...
class Project < ApplicationRecord
  ...
  #
  # Parameterized representation of project's name
  #
  # @return [String] Parameterized representation of project's name
  #
  def slug
  ...
  #
  # Convenience method to show the owner's name
  #
  # @return [String] display name of the project's associated user.
  #
  def owner
