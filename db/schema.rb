...
ActiveRecord::Schema.define(version: 20170523033345) do
  ...
  create_table "raster_layer_projects", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["raster_layer_id"], name: "index_raster_layer_projects_on_raster_layer_id", using: :btree
  end
  ...
  create_table "raster_layers", force: :cascade do |t|
    ...
    t.index ["institution_id"], name: "index_raster_layers_on_institution_id", using: :btree
  end
  ...
  create_table "vector_features", force: :cascade do |t|
    ...
    t.integer  "vector_layer_id"
    t.index ["vector_layer_id"], name: "belongs_to_vector_layer", using: :btree
    t.index ["vector_layer_id"], name: "index_vector_features_on_vector_layer_id", using: :btree
  end
  ...
  create_table "vector_layer_projects", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vector_layer_id"], name: "index_vector_layer_projects_on_vector_layer_id", using: :btree
  end
  ...
  create_table "vector_layers", force: :cascade do |t|
    ...
    t.string   "data_type",      limit: 255
    t.geometry "boundingbox",    limit: {:srid=>4326, :type=>"polygon"}
    t.index ["institution_id"], name: "index_vector_layers_on_institution_id", using: :btree
  end
