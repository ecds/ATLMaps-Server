...
class ProjectCrudTest < ActionDispatch::IntegrationTest
  ...
  test 'add raster layer to project as owner' do
      @request.headers['Authorization'] = 'Bearer a03832787c0c21e46e72c0be225e4a9bb9c189451a3bc002a99d4741425163cf'
      puts Login.where(oauth2_token: 'a03832787c0c21e46e72c0be225e4a9bb9c189451a3bc002a99d4741425163cf')
    ...
    headers: {Authorization: 'Bearer a03832787c0c21e46e72c0be225e4a9bb9c189451a3bc002a99d4741425163cf'},
    xhr: true
      puts '~~~~~~~~~~~~~~~~~~~~'
      pp(request.headers)
      assert_equal 201, response.status
